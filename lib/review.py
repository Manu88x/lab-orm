...
from employee import Employee  # Import Employee to check foreign key reference
...
class Review:
    ...
    def save(self):
        """ Insert a new review and save the object in the database """
        sql = """
    ...
    def find_by_id(cls, id):
        """Return Review instance corresponding to the table row matching the specified primary key"""
        sql = """
            SELECT *
            FROM reviews
            WHERE id = ?
